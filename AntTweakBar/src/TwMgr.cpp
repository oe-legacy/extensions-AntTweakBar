...
CTwMgr::CCursor CTwMgr::PixmapCursor(int _CurIdx) {
	...
	return CreateApplePixmapCursor(g_CurPict[_CurIdx], g_CurMask[_CurIdx], g_CurHot[_CurIdx]);
}

void CTwMgr::CreateCursors() {
	
	m_CursorArrow = CreateAppleCursor(AC_Arrow);
	m_CursorMove = CreateAppleCursor(AC_Cross);
	m_CursorWE = CreateAppleCursor(AC_Resize_Left);
	m_CursorNS = CreateAppleCursor(AC_Resize_Up);
	
	m_CursorTopRight = CreateAppleCursor(AC_Arrow);
	m_CursorTopLeft = CreateAppleCursor(AC_Arrow);
	m_CursorBottomRight = CreateAppleCursor(AC_Arrow);
	m_CursorBottomLeft = CreateAppleCursor(AC_Arrow);
	
	m_CursorHelp = CreateAppleCursor(AC_Cross);
	m_CursorHand = CreateAppleCursor(AC_Hand);
	m_CursorCross = CreateAppleCursor(AC_Cross);
	m_CursorUpArrow = CreateAppleCursor(AC_Cross);
	m_CursorNo = CreateAppleCursor(AC_Arrow);
	m_CursorIBeam = CreateAppleCursor(AC_IBeam);
...
void CTwMgr::FreeCursors() {
	...
	printf("NOO !!! free teh cursors!");
	
}
	
void CTwMgr::SetCursor(CTwMgr::CCursor _Cursor) {
	
	SetAppleCursor(_Cursor);
